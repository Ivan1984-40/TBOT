            ...
            for i, result in enumerate(tp_results):
                ...
                if not isinstance(result, Exception) and result:
                    ...
                    for original_lot in account_state.open_lots: 
                         if original_lot is lot or (original_lot.get('entry_price') == lot.get('entry_price') and original_lot.get('quantity') == lot.get('quantity') and original_lot.get('tp_order_id') is None):
